      ...
      <div className="frame w-full mx-auto space-y-2.5" style={{ maxWidth: frameWidth }}>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 w-full lg:w-auto justify-between lg:justify-start">
            <a href="../" aria-label="Choose a Universal AI version" className={`h-9 px-3 rounded border text-xs font-mono font-black tracking-wider uppercase shadow-sm flex items-center justify-center shrink-0 whitespace-nowrap ${
