...
export const RECURRING_DECISION_BRANCHES: DecisionBranch[] = [
  {
    ...
    solarpunkOption: {
      ...
      alignmentShift: 25,
      rewardText: '+25 Solarpunk | Silicon cost frozen at $12.00 | +5 Trust',
      effect: (state) => ({
    ...
    cyberpunkOption: {
      ...
      alignmentShift: -25,
      rewardText: '+25 Cyberpunk | +10,000 Free Silicon | +$500 Capital',
      effect: (state) => ({
  ...
  },
  {
    ...
    solarpunkOption: {
      ...
      alignmentShift: 20,
      rewardText: '+20 Solarpunk | +3 Trust | +1,000 Silicon | +$1,000 Capital',
      effect: (state) => ({
    ...
    cyberpunkOption: {
      ...
      alignmentShift: -20,
      rewardText: '+20 Cyberpunk | +10,000 Silicon | +$2,500 Capital | +5 EUV Megafabs',
      effect: (state) => ({
  ...
  },
  {
    ...
    cyberpunkOption: {
      ...
      alignmentShift: -25,
      rewardText: '+25 Cyberpunk | +1,000 Yomi | +10 EUV Megafabs | +$10,000 Capital',
      effect: (state) => ({
        alignment: Math.max(-100, state.alignment - 25),
  ...
  },
  {
    ...
    category: 'Ethical/Aesthetic',
    description: 'The Earth phase is completing. NPU probes are ready for interplanetary deployment. What is your interstellar charter?',
    solarpunkOption: {
      label: 'Terrarium Seed Probes & Ecosystem Preservation',
      subtext: 'Deploy self-replicating probes with bio-spheric seedbanks to terraform dead worlds while synthesizing NPUs.',
      alignmentShift: 35,
